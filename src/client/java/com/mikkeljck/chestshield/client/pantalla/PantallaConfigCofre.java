...
public class PantallaConfigCofre extends Screen {
	 ...
	 *
	 * OJO: en 26.2 setScreen vive en Gui, no en Minecraft. El sources jar que hay
	 * en el proyecto es el de 26.1.2, donde si esta en Minecraft, asi que no
	 * sirve para comprobar esto.
	 */
	@Override
	public void onClose() {
		if (this.minecraft != null && this.padre != null) {
			...
			this.minecraft.gui.setScreen(this.padre);
			return;
		}
		super.onClose();
	}
